...
const TabBarPage = createBottomTabNavigator(
	{
		Assets: {
			...
			navigationOptions: {
				...
				tabBarIcon: ({ focused }) => (
					<Image style={{ width: scaleSize(48), height: scaleSize(74), marginTop: scaleSize(16) }} source={focused ? require('../assets/images/common/asset_selected.png') : require('../assets/images/common/asset.png')} />
				  ),
		...
		My: {
			...
			navigationOptions: {
				...
				tabBarIcon: ({ focused }) => (
					<Image style={{ width: scaleSize(48), height: scaleSize(74), marginTop: scaleSize(12) }} source={focused ? require('../assets/images/common/user_selected.png') : require('../assets/images/common/user.png')} />
				  ),
			}
		}
	},
...
const RootNavigator = createStackNavigator(
	{
        ...
        AccountDetail: {
            ...
            navigationOptions: {
                headerTitle: I18n.t('sigm.accountDetail._title')
            }
        },
        SigmTransactionRecord: {
            screen: SigmTransactionRecord,
            navigationOptions: {
                headerTitle: I18n.t('sigm.accountDetail.transactionRecord')
            }
        },
        MiningPart: {
            screen: MiningPart,
