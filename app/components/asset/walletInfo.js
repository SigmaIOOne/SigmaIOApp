...
class WalletInfo extends Component {
	static navigationOptions = {
		headerTitle: I18n.t('assets.walletInfo._title')
	};
	constructor(props) {
		super(props);
	...
	clickToWalletName = () => {
		...
		checkWalletName(this.state.newWalletName).then(() => {
			...
			const walletInfo = this.props.wallet.walletInfo;
			walletInfo.walletName = this.state.newWalletName;
			this.props.updateWalletInfo(walletInfo);
	...
	render() {
		return (
			<View style={styles.container}>
				...
				<Modal
					...
					<View style={styles.confirm}>
						<Button
							...
							buttonStyle={[styles.confirmButtonStyle, styles.btnStyle]}
                            disabled={this.state.walletPassword === null || this.state.walletPassword.trim() === ''}
				...
				<Modal
					style={[styles.modalCode, styles.exportPrivateKeyModal]}
					position={'center'}
					coverScreen={true}
					ref={'privateKey'}
					swipeArea={20}
					...
					<View style={styles.copy}>
						<Button
							...
							buttonStyle={[styles.copyButtonStyle, styles.btnStyle]}
