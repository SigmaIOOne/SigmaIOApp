		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.inputbox}>
					...
					<Input
						placeholder={I18n.t('assets.currency.transferCountPlaceholder')}
						// "转账金额"
						onChangeText={(amount) => {
				...
				<Modal
					...
					swipeArea={20}
					>
					<ScrollView style={{position: 'relative', marginLeft: scaleSize(20), marginRight: scaleSize(20)}}>
						...
						<Modal
							...
							>
							<View>
								<View style={[styles.paymentDetails_title, styles.paymentDetails_title_2]}>
									<Text style={styles.paymentDetails_title_text}>{I18n.t('public.verifyPwd')}</Text>
								</View>
								<Input
                                    ...
                                    style={{fontSize: scaleSize(30)}}
								/>
								<View style={styles.pwdNext}>
									<Button
										title={I18n.t('public.next')} //"下一步"
										buttonStyle={styles.pwdButtonStyle}
                                        disabledStyle={styles.pwdDisabledStyle}
                                        disabled={ this.state.password === null || this.state.password.trim() === '' }
										onPress={() => {
											this.refs.transferDetail.close();
...
const styles = StyleSheet.create({
    ...
    paymentDetails_title_2: {
        paddingTop: scaleSize(30),
        marginTop: scaleSize(30)
    },
    paymentDetails_title_text: {
