	...
	render() {
		return (
			<View style={styles.container}>
				<ImageBackground style={{ width: scaleSize(670), height: scaleSize(290), marginTop: scaleSize(20), backgroundColor: '#fff' }}
                                 source={ this.state.currencyName === 'ETH' ? require('../../assets/images/asset/currency_eth.png') : require('../../assets/images/asset/currency_sigmlO.png')}>
